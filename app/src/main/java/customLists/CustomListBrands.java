...
public class CustomListBrands extends ArrayAdapter<DataInBrands.BrandContent> {
    private Activity Activity;
    private ArrayList<DataInBrands.BrandContent> Data;
    private DisplayImageOptions options;

    public CustomListBrands(Activity context, ArrayList<DataInBrands.BrandContent> data) {
        super(context, R.layout.singel_brand_list2, data);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.singel_brand_list2, null, true);
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                Data = (ArrayList<DataInBrands.BrandContent>) results.values;
                notifyDataSetChanged();
            }

            @Override
            protected FilterResults performFiltering(CharSequence constraint) {
                ArrayList<DataInBrands.BrandContent> filteredResults = getFilteredResults(constraint);
    ...
    private ArrayList<DataInBrands.BrandContent> getFilteredResults(CharSequence constraint) {
