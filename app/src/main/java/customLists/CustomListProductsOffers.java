...
public class CustomListProductsOffers extends ArrayAdapter<DataInProdOffers.OfferContent> {
    private Activity Activity;
    private ArrayList<DataInProdOffers.OfferContent> Data;
    private DisplayImageOptions options;
    private Typeface fontMedim, fontLight, fontUltra, fontAvenir;

    public CustomListProductsOffers(Activity context, ArrayList<DataInProdOffers.OfferContent> data) {
    ...
    public Filter getFilter() {
        return new Filter() {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                Data = (ArrayList<DataInProdOffers.OfferContent>) results.values;
                notifyDataSetChanged();
            }

            @Override
            protected FilterResults performFiltering(CharSequence constraint) {
                ArrayList<DataInProdOffers.OfferContent> filteredResults = getFilteredResults(constraint);
    ...
    private ArrayList<DataInProdOffers.OfferContent> getFilteredResults(CharSequence constraint) {
